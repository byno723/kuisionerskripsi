...
<head>
  ...
  <!-- Favicons -->
  <link href="<?= base_url('assets/'); ?>vendoradmin/img/favicon.png" rel="icon">
...
<body style="background-image: url('<?= base_url('assets/vendoradmin/img/blog-3.jpg'); ?>'); background-repeat:no-repeat;
